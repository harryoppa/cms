...
namespace TVHung\Base\Http\Controllers;
...
use TVHung\Base\Supports\MembershipAuthorization;
use TVHung\Base\Supports\SystemManagement;
use TVHung\Base\Tables\InfoTable;
