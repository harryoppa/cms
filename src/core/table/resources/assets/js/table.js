(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', TvhungVariables.languages.tables.excel ? TvhungVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', TvhungVariables.languages.tables.export ? TvhungVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', TvhungVariables.languages.tables.csv ? TvhungVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', TvhungVariables.languages.tables.print ? TvhungVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', TvhungVariables.languages.tables.reset ? TvhungVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', TvhungVariables.languages.tables.reload ? TvhungVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    TVHung.showError(TvhungVariables.languages.tables.please_select_record ? TvhungVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }
