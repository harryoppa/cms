...
namespace TVHung\ACL\Http\Controllers;
...
use TVHung\ACL\Forms\PasswordForm;
use TVHung\ACL\Forms\ProfileForm;
use TVHung\ACL\Forms\UserForm;
use TVHung\ACL\Tables\UserTable;
use TVHung\ACL\Http\Requests\CreateUserRequest;
use TVHung\ACL\Http\Requests\UpdatePasswordRequest;
use TVHung\ACL\Http\Requests\UpdateProfileRequest;
use TVHung\ACL\Models\UserMeta;
use TVHung\ACL\Repositories\Interfaces\RoleInterface;
use TVHung\ACL\Repositories\Interfaces\UserInterface;
use TVHung\ACL\Services\ChangePasswordService;
use TVHung\ACL\Services\CreateUserService;
...
use TVHung\ACL\Http\Requests\AvatarRequest;
use Exception;
