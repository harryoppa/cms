...
use TVHung\ACL\Http\Controllers\Auth\ForgotPasswordController;
use TVHung\ACL\Http\Controllers\Auth\LoginController;
use TVHung\ACL\Http\Controllers\Auth\ResetPasswordController;
use TVHung\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'TVHung\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
