...
namespace TVHung\PaginateRoute;
...
class PaginateRoute
{
     ...
     * @return string
     */
    public function renderPageList(LengthAwarePaginator $paginator, $full = false, $class = null, $additionalLinks = true)
    {
     ...
     * @return $this
     */
    public function resolver(): PaginateRoute
    {
        return $this;
    }
    ...
    public function registerMacros()
    {
        ...
        $router->macro('paginate', function ($uri, $action) use ($pageKeyword, $router) {
            ...
            $router->group(
                ['middleware' => 'TVHung\PaginateRoute\Http\Middleware\SetPageMiddleware'],
